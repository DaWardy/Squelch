...
[![GitHub](https://img.shields.io/badge/github-dawardy%2Fapex-3fbe6f)](https://github.com/dawardy/squelch)
...
1. [What Squelch Does](#what-apex-does)
2. [Hardware](#hardware)
3. [Quick Start](#quick-start)
4. [Step-by-Step Installation](#step-by-step-installation)
5. [SDR Driver Installation](#sdr-driver-installation)
6. [External Program Setup](#external-program-setup)
7. [First Launch](#first-launch)
8. [Configuration](#configuration)
9. [Launching Squelch](#launching-apex)
10. [Lab Mode](#lab-mode)
11. [Guest and Student Operators](#guest-and-student-operators)
12. [Updating](#updating)
13. [Troubleshooting](#troubleshooting)
14. [Legal and Ethics](#legal-and-ethics)
15. [Credits](#credits)
...
- [Hamlib](https://hamlib.sourceforge.net/) — LGPL 2.1
- [SoapySDR](https://github.com/pothosware/SoapySDR) — Boost License
- [PyQt6](https://riverbankcomputing.com/software/pyqt/) — GPL v3
- [WSJT-X](https://wsjt.sourceforge.io/) — GPL v3 (K1JT et al.)
- [Fldigi](https://sourceforge.net/projects/fldigi/) — GPL v3 (W1HKJ)
- [OP25](https://github.com/osmocom/op25) — GPL v3 (Osmocom)
- [dump1090-fa](https://github.com/flightaware/dump1090) — GPL v2 (FlightAware)
- [NumPy](https://numpy.org/) / [SciPy](https://scipy.org/) — BSD
- [folium](https://python-visualization.github.io/folium/) — MIT
- [geopy](https://github.com/geopy/geopy) — MIT
- [maidenhead](https://github.com/space-physics/maidenhead) — MIT
- [mgrs](https://github.com/heltonbiker/mgrs) — MIT

**Proprietary components (separate install):**
- [VARA / VARA HF](https://rosmodem.wordpress.com/) — EA5HVK, freeware/paid
- [DSD+](https://www.dsdplus.com/) — freeware
