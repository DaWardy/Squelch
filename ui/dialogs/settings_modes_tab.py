...
class _SettingsModesTab:
    ...
    def _build_wsjtx_section(self, f: "QFormLayout") -> None:
        ...
        self._auto_log_ft8 = QCheckBox("Auto-log FT8 QSOs from WSJT-X")
    ...
    def _build_ptt_section(self, f: "QFormLayout") -> None:
        f.addRow(_sep())
    ...
    def _build_modes_logging_section(self, f: "QFormLayout") -> None:
        f.addRow(_sep())
        _section(f, "Logging")
    ...
    def _tab_modes(self) -> "QWidget":
        ...
        self._build_wsjtx_section(f)
        self._build_ptt_section(f)
        self._build_modes_logging_section(f)
        return w
