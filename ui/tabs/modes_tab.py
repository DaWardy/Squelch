...
from ui.tabs.modes_sota_mixin import _ModesSOTAMixin
from ui.tabs.modes_dx_mixin import _ModesDXMixin
...
class ModesTab(_ModesSSTVMixin, _ModesRBNMixin, _ModesSOTAMixin, _ModesDXMixin,
               SquelchPanel, QWidget):
    panel_id    = "modes"
