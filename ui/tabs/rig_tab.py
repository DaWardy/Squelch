...
from ui.tabs.rig_scanner_mixin import _RigScannerMixin
from ui.tabs.rig_memory_mixin import _RigMemoryMixin
...
class RigTab(_RigRotorMixin, _RigVoiceMixin, _RigCWMixin, _RigScannerMixin,
             _RigMemoryMixin, SquelchPanel, QWidget):
    panel_id    = "rig"
    panel_title = "Rig"
